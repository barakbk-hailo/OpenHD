...
For documentation on the Hailo AI drone-following integration (architecture, build instructions, configuration, and changelogs), see link:HAILO_INTEGRATION.md[HAILO_INTEGRATION.md].
